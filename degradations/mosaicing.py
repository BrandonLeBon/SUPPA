...
from degradations.utils.arguments import mosaicing_read_arguments
...
#####################LOADING VARIABLES##########################
input_dataset, output_dataset, nb_channels, noise_sigma = mosaicing_read_arguments()
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

#####################LOADING OPERATOR##########################
forward_operator = Mosaicing(device=device).to(device=device)
